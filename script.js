window.addEventListener("load", function () {
    ...
    class Player {
      ...
      update() {
        ...
        if (this.collisionX < this.game.topMargin + this.collisionRadius)
          this.collisionX = this.game.topMargin + this.collisionRadius;
    ...
    class Obstacle { // images are sepated from objstacles
      constructor(game) {
        this.game = game;
    ...
    class Egg {
      constructor(game) {
        ...
        this.collisionY =
          this.game.topMargin +
          Math.random() * (this.game.height - this.topMargin - this.margin);
      ...
      update(deltaTime) {
        ...
        collisionOjects.forEach((object) => {
          let [collision, distance, sumOfRadii, dx, dy] =
        ...
        if (this.collisionY < this.game.topMargin) {
          ...
          for (let i = 0; i < 3; i++) {
            this.game.particles.push(
              new Firefly(this.game, this.collisionX, this.collisionY, "yello")
            );
          }
        }
        // Collision with objects
        let collisionObjects = [this.game.player, ...this.enemies];
    ...
    class Enemy {
      ...
      update() {
        ...
        if (this.speedX + this.width < 0 && !this.game.gameOver) {
          this.collisionX =
            this.game.width + this.width + Math.random() * this.game.width * 0.5;
          this.collisionY =
            this.game.topMargin +
        ...
        let collisionOjects = [this.game.player, ...this.game.obstacles];
        collisionOjects.forEach((object) => {
          let [collision, distance, sumOfRadii, dx, dy] =
            this.game.checkCollision(this, object);
          if (collision) {
